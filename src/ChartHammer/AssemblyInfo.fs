...
[<assembly: AssemblyTitleAttribute("ChartHammer")>]
[<assembly: AssemblyProductAttribute("ChartHammer")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "ChartHammer"
    let [<Literal>] AssemblyProduct = "ChartHammer"
